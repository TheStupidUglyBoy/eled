		            ...
		            <div class="card-body">
		            	...
		            	@csrf
		            		<div class="form-group">
		                      <input type="text" class="form-control" name="question" placeholder="Enter Tips Question">
		                    </div>
		            		
		            		<div class="form-group">

		                      <textarea class="form-control" id="editor" name="answer" rows="10" cols="50" ></textarea>
		                    </div>
