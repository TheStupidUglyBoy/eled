		            ...
		            <div class="card-body">
		            	...
		            	@method('PATCH')
		            		<div class="form-group">
		                      <input type="text" class="form-control" name="title" placeholder="Enter New Title" value="{{$news->title}}">
		                    </div>

		                    <div class="form-group">
		                      <textarea class="form-control" id="editor" name="body" rows="10" cols="50" >{!!    clean($news->getAttributes()['body'])   !!}</textarea>
		                    </div>
		                    ...
		                    <div class="form-group">
							 ...
							 @if (  $news->image->isNotEmpty()   )
							 	@foreach ( $news->image as $image  )  
	                            	<p> <img src="{{asset($image->name)}}" width='100' height="100" /> </p>
	                            @endforeach 
							 @endif
